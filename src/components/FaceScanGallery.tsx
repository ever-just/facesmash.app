        ...
        {faceScans.length === 0 ? <div className="text-center py-8">
            ...
            slidesToScroll: 1
                ...
                <CarouselContent className="-ml-2 md:-ml-4">
                  {faceScans.map((scan, index) => <CarouselItem key={scan.id} className="pl-2 md:pl-4 md:basis-1/3">
                        ...
                        <div className="bg-gray-800 rounded-xl overflow-hidden border border-gray-700 w-72 shadow-2xl transition-transform duration-200 hover:scale-105">
                          ...
                          <div className="aspect-square relative">
                            {imageLoadErrors.has(scan.id) ? <div className="w-full h-full bg-gray-700 flex items-center justify-center flex-col">
                                ...
                                <Button onClick={() => retryImageLoad(scan.id)} variant="outline" size="sm" className="border-red-400 text-red-400 hover:bg-red-400 hover:text-white text-xs">
